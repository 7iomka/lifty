...
<body class="js">
    <div class="site-wrapper">
                    ...
                    <div class="header__form site-form site-form--light inline-form inline-form--with-left-bg inline--action">
                        <form method="POST" action="/ajax.php">
                            ...
                            <div class="form-legend">
                              ...
                              <span class="site-form__action-result">месяц бесплатного <br/>обслуживания лифтов</span>
                            </div>
        ...
        <section class="reviews reviews--service s22 ">
        ...
        <section class="services services--engineering s23">
          <div class="container">
            <div class="row">
